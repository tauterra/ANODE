...
<Library LVVersion="19008000">
	...
	<Item Name="test-state-machine.vi" Type="VI" URL="../test-state-machine.vi"/>
	<Item Name="guards.vi" Type="VI" URL="../guards.vi"/>
	<Item Name="actions.vi" Type="VI" URL="../actions.vi"/>
	<Item Name="State Type.ctl" Type="VI" URL="../State Type.ctl"/>
	<Item Name="Action Type.ctl" Type="VI" URL="../Action Type.ctl"/>
	<Item Name="Event Type.ctl" Type="VI" URL="../Event Type.ctl"/>
	<Item Name="Guard Type.ctl" Type="VI" URL="../Guard Type.ctl"/>
